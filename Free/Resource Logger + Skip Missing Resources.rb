...
%Q{
  ...
  || Introduction ||
  ------------------
  Have a hard time to select which resources are used within your game?
  This script will help you checking resources that are used within the default
  database. Including Audio and Graphics. However it won't check any resources
  that is used by custom script. It does however skip missing resources and 
  create a file to write out which are missing
  
  ================
  || How to use ||
  ----------------
  Put the script above main. Use TESTPLAY because it only works on it.
  
  Set Activate to false if you want to turn off this script. Or simply put it
  below main.
...
module Theo
  module ResLog
    ...
    Activate  = true  # Activate? (true/false)
    Check     = true  # Want to check if resources are missing?
    EndWait   = 120   # Wait (in frame) after checking
    
    LogName   = "ResourceLog"
  # File name to write the resource log
  
    MissName  = "MissingResources"
  # File name for missing resources
    
    MissingSkip = true 
  # Want to game keep continue even when the it has missing resources?
    
  end
end

#==============================================================================
# Sacred area, do not cross!
#==============================================================================
